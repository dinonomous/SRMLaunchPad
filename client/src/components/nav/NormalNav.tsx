...
const NormalNav: React.FC<NormalNavProps> = ({ closed = false }) => {
  ...
  if (isLoading)
    return (
      <nav className={`${closed? "z-50 bg-white dark:bg-DarkPrimary-200 border-gray-200 dark:border-gray-700 fixed top-0 left-0 right-0 h-20 flex justify-between items-center": "z-50 bg-white dark:bg-DarkPrimary-200 border-gray-200 dark:border-gray-700 fixed top-0 left-0 right-0 rounded-full m-6 h-20 flex justify-between items-center"}`}>
...
export default React.memo(NormalNav);
